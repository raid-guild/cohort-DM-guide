...
# <img src="/iconography/dd/community.svg" alt="Cohort participants icon" className="rg-inline-icon" />3.2 Cohort Participants (Adventurers)
...
# <img src="/iconography/dd/consultation.svg" alt="Presenters and experts icon" className="rg-inline-icon" />3.3 Presenters & Experts (Lorekeepers)
...
# <img src="/iconography/dd/education.svg" alt="Mentors icon" className="rg-inline-icon" />3.4 Mentors (High Mages, Rangers, Paladins)
...
# <img src="/iconography/dd/culture.svg" alt="Judges council icon" className="rg-inline-icon" />3.5 Judges (Elders Council)
...
# <img src="/iconography/dd/fullstack.svg" alt="Alumni and OG raiders icon" className="rg-inline-icon" />3.6 Alumni & OG Raiders (Wandering Veterans)
...
# <img src="/iconography/dd/sprint.svg" alt="Project teams icon" className="rg-inline-icon" />3.7 Project Teams (Parties of Adventure)
...
# <img src="/iconography/dd/spear.svg" alt="DM crew icon" className="rg-inline-icon" />3.8 The DM Crew (Support Staff & Co-hosts)
