...
<div className="rg-hero">
  <img src="/assets/headers/tower-floating.webp" alt="Quest tower illustration" loading="lazy" />
</div>

Every cohort has a **Main Quest**: a theme-driven build challenge that all participants engage with. This quest anchors the cohort, gives teams shared purpose, and produces the demos showcased in the next cohort’s Week 1.
...
# <img src="/iconography/dd/swords.svg" alt="Main Quest icon" className="rg-inline-icon" />5.1 The Main Quest (Required)
...
Build a working prototype, research artifact, product spec, or operational improvement *aligned with the theme*.
...
# <img src="/iconography/magic/star.svg" alt="Side quests icon" className="rg-inline-icon" />5.2 Side Quests (Optional)

Side Quests are missions for ambitious Raiders who want to go above and beyond.
They are optional, open-ended, and self-directed.
...
# <img src="/iconography/dd/swords.svg" alt="Quest completion and Demo Day icon" className="rg-inline-icon" />5.3 Quest Completion & Demo Day

Whether pursuing the Main Quest or a Side Quest, participants share the same final ritual:
**Demo Day.**
...
# <img src="/iconography/dd/manifesto.svg" alt="Theme selection icon" className="rg-inline-icon" />5.4 Theme Selection (How the Main Quest Is Chosen)
...
#### **3. Ecosystem Trends & Conference Hype**
